...
class Spider(BaseSpider):
    ...
    def detailContent(self, ids):
        try:
            ...
            if not vod_content:
                vod_content = data('h1').text() or '007吃瓜网'

            return {'list': [{'vod_play_from': '007吃瓜网', 'vod_play_url': play_url, 'vod_content': vod_content}]}
        except:
            return {'list': [{'vod_play_from': '007吃瓜网', 'vod_play_url': '获取失败'}]}
